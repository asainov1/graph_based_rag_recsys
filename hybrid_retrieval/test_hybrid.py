...
sys.path.insert(0, project_root)   # <- put this back
print(f"Working directory: {os.getcwd()}")

from dotenv import load_dotenv
load_dotenv()

BM25_DIR = os.getenv("BM25_DOCS_DIR", "data/documents")
DENSE_BACKEND = os.getenv("DENSE_BACKEND", "qdrant")
QDRANT_HOST = os.getenv("QDRANT_HOST", "localhost")
QDRANT_PORT = int(os.getenv("QDRANT_PORT", "6333"))
QDRANT_COLLECTION = os.getenv("QDRANT_COLLECTION", "ethz_news")
GRAPH_PATH = os.getenv("GRAPH_PATH", "data/graphrag/graph.pickle")
ENTITY_CHUNKS_PATH = os.getenv("ENTITY_CHUNKS_PATH", "data/graphrag/entity_chunks.pickle")
...
def main():
    ...
    try:
        print("\n1. Initializing BM25...")
        bm25 = BM25Adapter(docs_directory=BM25_DIR) # corrected
    ...
    try:
        ...
        dense = DenseAdapter(
            backend=DENSE_BACKEND,              # "qdrant"
            qdrant_host=QDRANT_HOST,
            qdrant_port=QDRANT_PORT,
            qdrant_collection=QDRANT_COLLECTION
            # (only pass chroma_path if backend="chroma")
        )
    ...
    try:
        ...
        graphrag = GraphRAGAdapter(
            graph_path="data/graphrag/graph.pickle",
            entity_chunks_path="data/graphrag/entity_chunks.pickle"
        ) # corrected 
